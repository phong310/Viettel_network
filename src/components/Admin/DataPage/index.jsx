...
export default function DataPage({ tab, dataList, triggerSearch }) {
  ...
  useEffect(() => {
    if (dataList.length > 0) {
      ...
      setRowData(dataNetwork)
    }

  }, [dataNetwork, dataList, triggerSearch])
                          ...
                          return (
                            <TableCell key={column.id} align={column.align} >
                              ...
                              <IconButton aria-label="edit" size="small" sx={{ ...colorMain }}>
                                <Tooltip title="Chi tiết" placement="top" onClick={() => handleDetail(row)}>
                                  <RemoveRedEyeIcon />
                                </Tooltip>
                              </IconButton>
